...
포스트 글의 제목 바로 밑에 date를 추가하고 싶다면, `_layout/single.html`을 다음과 같이 수정하여, `page__meta` 클래스 대신에 `page__date` 클래스로 바꾸자.

[수정된 코드 바로가기](https://github.com/devinlife/devinlife.github.io/commit/c6a8fe5a2f2a6f208b4ad90528074842e5c3ee66)
...
아카이브 페이지에서 `read_time` 대신 `date`를 표시하고 싶다면, `_includes/archive-single.html`을 다음과 같이 수정하자.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2ODY2ODE3MzAsLTkxMzE4NzIwMSwtMT
c4NDMwMTE3MSwtOTI2ODYwNTkxLC03MTc5NDE0NTJdfQ==
-->