...
포스트 글의 제목 바로 밑에 date를 추가하고 싶다면, `_layout/single.html`을 다음과 같이 수정하여, `page__meta` 클래스 대신에 `page__date` 클래스로 바꾸자.[[참고]](https://github.com/devinlife/devinlife.github.io/commit/c6a8fe5a2f2a6f208b4ad90528074842e5c3ee66)
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzY4NTE1Mjc4LC0xNjg2NjgxNzMwLC05MT
MxODcyMDEsLTE3ODQzMDExNzEsLTkyNjg2MDU5MSwtNzE3OTQx
NDUyXX0=
-->