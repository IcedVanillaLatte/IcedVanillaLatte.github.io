...
<hr>
<h2 id="title-test-with-stackeditlayout-splashclasses--landing--dark-themecategories-markdowntoc-truetoc_label-table-of-contentspublished-true">title: “test with <abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr>”<br>
layout: splash<br>
classes:<br>
- landing<br>
- dark-theme<br>
categories: Markdown<br>
toc: true<br>
toc_label: “Table of Contents”<br>
published: true</h2>
<h1 id="welcome-to-stackedit-ver.2">Welcome to <abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr>! Ver.2</h1>
<p>Hi! I’m your first Markdown file in <strong><abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr></strong>. If you want to learn about <abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr>, you can read me. If you want to play with Markdown, you can edit me. Once you have finished with me, you can create new files by opening the <strong>file explorer</strong> on the left corner of the navigation bar.</p>
<p><img src="/assets/images/test.jpg?raw=true" alt="an image in my repository">{: width=“100”, height=“200”}</p>
<h1 id="한글도-지원하나">한글도 지원하나?</h1>
<ul>
<li>여러가지 마크다운<sup class="footnote-ref"><a href="#fn1" id="fnref1">1</a></sup>은?</li>
</ul>
<h1 id="files">Files</h1>
<p><abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr> stores your files in your browser, which means all your files are automatically saved locally and are accessible <strong>offline!</strong></p>
...
<p>You can save any file of the workspace to <strong>Google Drive</strong>, <strong>Dropbox</strong> or <strong>GitHub</strong> by opening the <strong>Synchronize</strong> sub-menu and clicking <strong>Save on</strong>. Even if a file in the workspace is already synced, you can save it to another location. <abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr> can sync one file with multiple locations and accounts.</p>
<h2 id="synchronize-a-file">Synchronize a file</h2>
<p>Once your file is linked to a synchronized location, <abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr> will periodically synchronize it by downloading/uploading any modification. A merge will be performed if necessary and conflicts will be resolved.</p>
...
<p>Publishing in <abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr> makes it simple for you to publish online your files. Once you’re happy with a file, you can publish it to different hosting platforms like <strong>Blogger</strong>, <strong>Dropbox</strong>, <strong>Gist</strong>, <strong>GitHub</strong>, <strong>Google Drive</strong>, <strong>WordPress</strong> and <strong>Zendesk</strong>. With <a href="http://handlebarsjs.com/">Handlebars templates</a>, you have full control over what you export.</p>
<blockquote>
...
<p>After publishing, <abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr> keeps your file linked to that publication which makes it easy for you to re-publish it. Once you have modified your file and you want to update your publication, click on the <strong>Publish now</strong> button in the navigation bar.</p>
<blockquote>
...
<p><abbr title="마크다운을 사용할 수 있는 오픈 웹 서비스">StackEdit</abbr> extends the standard Markdown syntax by adding extra <strong>Markdown extensions</strong>, providing you with some nice features.</p>
<blockquote>
...
<p>You can render UML diagrams using <a href="https://mermaidjs.github.io/">Mermaid</a>. For example, this will produce a sequence diagram: ver 6.</p>
<pre class=" language-html"><code class="prism  language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>https://unpkg.com/mermaid@8.4.8/dist/mermaid.core.js<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span><span class="token script language-javascript"></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>mermaid<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
sequenceDiagram;
Alice -&gt;&gt; Bob: Hello Bob, how are you?;
Bob--&gt;&gt;John: How about you John?;
Bob--x Alice: I am good thanks!;
Bob-x John: I am good thanks!;
Note right of John: Bob thinks a long<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span><span class="token punctuation">/&gt;</span></span>long time, so long<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span><span class="token punctuation">/&gt;</span></span>that the text does<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span><span class="token punctuation">/&gt;</span></span>not fit on a row.;
...
<hr>
<pre class=" language-html"><code class="prism  language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>mermaid<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
graph TD;
    A--&gt;B;
    A--&gt;C;
    B--&gt;D;
...
You can render UML diagrams using [Mermaid](https://mermaidjs.github.io/). For example, this will produce a sequence diagram: ver 6.
...
<li id="fn1" class="footnote-item"><p>마크다운을 말함 <a href="#fnref1" class="footnote-backref">↩︎</a></p>
</li>
</ol>
</section>
---------
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTE2MzUyNDRdfQ==
-->